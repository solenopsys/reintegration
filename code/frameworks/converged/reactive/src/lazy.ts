...
const lazyArrayPush = <T, U extends string>(
	obj: Partial<Record<U, LazyArray<T>>>,
	key: U,
	value: T,
): void => {
...
const lazySetAdd = <T, U extends string>(
	obj: Partial<Record<U, LazySet<T>>>,
	key: U,
	value: T,
): void => {
...
const lazySetDelete = <T, U extends string>(
	obj: Partial<Record<U, LazySet<T>>>,
	key: U,
	value: T,
): void => {
